...
import { Cascader, Col, Form, Input, Modal, Row, Spin, Upload, message } from 'antd';
import React, { useEffect, useRef, useState } from 'react';
import { DndContext, PointerSensor, useSensor } from '@dnd-kit/core';
import { SortableContext, arrayMove, useSortable, verticalListSortingStrategy } from '@dnd-kit/sortable';
import { CSS } from '@dnd-kit/utilities';
import CustomSelect from 'src/sections/dashboard/templates/CustomSelect';
import EditPriceForm from './edit-price';
    ...
    <div>
      ...
      >
        <Spin spinning={loading}>
          ...
          <div className="">
            <Button variant="contained" className="mt-4 w-[200px]" type="submit">
