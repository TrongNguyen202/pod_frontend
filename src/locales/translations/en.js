...
export const en = {
  ...
  [tokens.nav.lastUpdate]: 'Last Updated Date',
  ...
  [tokens.nav.chooseBoard]:
    'Please select a table to use the function, if there is no table, try creating it in the function bar on the left',
  [tokens.nav.balances]: 'Balances',
  [tokens.nav.success]: 'Success',
  [tokens.nav.pending]: 'Pending',
  [tokens.nav.downloadAll]: 'Download All',
  [tokens.nav.uploadPsd]: 'You can upload file .psd <= 50MB',
  [tokens.nav.phone]: 'Phone',
  [tokens.nav.role]: 'Role',
  [tokens.nav.active]: 'Active',
  [tokens.nav.inactive]: 'Inactive',
  [tokens.nav.accountInfo]: 'Account Info',
  [tokens.nav.advancedFilter]: 'Advanced Filter',
  [tokens.nav.increase]: 'Increase',
  [tokens.nav.decreasing]: 'Decreasing',
  [tokens.nav.from]: 'From',
  [tokens.nav.to]: 'To',
};
